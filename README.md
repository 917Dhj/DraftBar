...
A tiny menu bar scratchpad for quick drafts on macOS. ✏️
...
<p align="center">
  <strong><a href="https://github.com/917Dhj/DraftBar/releases/latest">📥 Download for macOS</a></strong>
</p>
...
| 🖥️ Native macOS feel | A small accessory app with a translucent floating panel and status icon states. |

## 📥 Install

1. Download the latest `.dmg` from [GitHub Releases](https://github.com/917Dhj/DraftBar/releases/latest).
